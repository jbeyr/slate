package slate.clickgui;

import slate.Main;
import slate.clickgui.components.Component;
import slate.clickgui.components.IComponent;
import slate.clickgui.components.impl.BindComponent;
...
import slate.utility.render.GradientBlur;
...
public class ClickGui extends GuiScreen {
    ...
    public void initMain() {
        ...
        this.sf = Main.getExecutor().schedule(() -> (this.aL = new Timer(650.0F)).start(), 650L, TimeUnit.MILLISECONDS);
    }
