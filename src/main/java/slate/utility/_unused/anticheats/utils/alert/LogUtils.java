package slate.utility._unused.anticheats.utils.alert;
...
public class LogUtils {
    ...
    public static void alert(String player, String module, String extraMsg) {
        if (check()) {
            ...
            Main.mc.thePlayer.addChatMessage(chatComponentText);
            // if (Anticheat.getShouldPing().isToggled()) {
            //     switch ((int) Anticheat.getPingSound().getInput()) {
            //         case 0:
            //             Main.mc.thePlayer.playSound("note.pling", 1, 1);
            //             break;
            //         case 1:
            //             Main.mc.thePlayer.playSound("slate:alarm", 1, 1);
            //             break;
            //     }
            //
            // }
    ...
    public static void prefix(String prefix, String msg) {
        if (check()) {
            Main.mc.thePlayer.addChatMessage(new ChatComponentText(
