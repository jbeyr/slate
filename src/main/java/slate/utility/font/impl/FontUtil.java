package slate.utility.font.impl;
...
public class FontUtil {
    ...
    private static final IResourceManager RESOURCE_MANAGER = Main.mc.getResourceManager();
    ...
    public static Font getResource(String location, int size) {
        ...
        try {
            InputStream is = mc.getResourceManager().getResource(new ResourceLocation(Main.MODID + ":fonts/" + location)).getInputStream();
