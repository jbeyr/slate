...
import slate.Main;
import slate.utility.ShaderUtils;
...
public class RRectUtils {
    public static final ShaderUtils roundedShader = new ShaderUtils(Main.MODID + ":shaders/rrect.frag");
    public static final ShaderUtils roundedOutlineShader = new ShaderUtils(Main.MODID + ":shaders/rrectOutline.frag");
    private static final ShaderUtils roundedGradientShader = new ShaderUtils(Main.MODID + ":shaders/rrectGradient.frag");
