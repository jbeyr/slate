...
public class BackgroundUtils {
    public static final ResourceLocation RES_LOGO = new ResourceLocation(Main.MODID + ":textures/backgrounds/ravenxd.png");
    ...
    static {
        BACKGROUNDS.add(new ResourceLocation(Main.MODID + ":textures/backgrounds/1.png"));
        BACKGROUNDS.add(new ResourceLocation(Main.MODID + ":textures/backgrounds/2.png"));
        BACKGROUNDS.add(new ResourceLocation(Main.MODID + ":textures/backgrounds/3.png"));
        BACKGROUNDS.add(new ResourceLocation(Main.MODID + ":textures/backgrounds/4.png"));
        BACKGROUNDS.add(new ResourceLocation(Main.MODID + ":textures/backgrounds/5.png"));
