package slate.utility.render.blur;

import slate.Main;
import slate.utility.render.ColorUtils;
...
import static slate.utility.render.blur.StencilUtil.checkSetupFBO;
import static org.lwjgl.opengl.GL11.*;
import static org.lwjgl.opengl.GL20.glUniform1;

public class GaussianBlur {

    private static final ShaderUtil gaussianBlur = new ShaderUtil(Main.MODID + ":shaders/gaussian.frag");
