...
import slate.clickgui.components.impl.CategoryComponent;
import slate.event.WorldChangeEvent;
import slate.module.Module;
import slate.module.impl.client.Gui;
import slate.module.impl.render.HUD;
import slate.module.impl.render.TargetHUD;
import slate.module.impl.render.Watermark;
...
import slate.module.setting.interfaces.InputSetting;
...
public class ProfileManager {
    ...
    public ProfileManager() {
        directory = new File(mc.mcDataDir + File.separator + Main.MODID, "profiles");
        if (!directory.exists()) {
        ...
        Main.getExecutor().schedule(this::updateLatest, 5, TimeUnit.MINUTES);
    }
        ...
        for (File file : getProfileFiles()) {
            ...
            try (FileReader fileReader = new FileReader(file)) {
                ...
                for (JsonElement moduleJson : modules) {
                    ...
                    Main.currentProfile = getProfile(name);
                }
    ...
    public void loadProfiles() {
        ...
        if (directory.exists()) {
            ...
            Utils.sendMessage("&b" + Main.profileManager.getProfileFiles().size() + " &7profiles loaded.");
        }
    }
