...
public class TargetHUD extends Module {
    ...
    public void onUpdate() {
        ...
        // manual target
        // TODO uncomment if we prefer manual target hud mechanism over TargetManager
//        if (target != null) {
...
//        }
    ...
    @SubscribeEvent
    public void onSwitchTarget(SwitchTargetEvent e) {
        target = e.getTarget().orElse(null);
        lastTargetTime = System.currentTimeMillis();
    }
