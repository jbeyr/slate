...
import slate.utility.render.progress.Progress;
import slate.utility.render.progress.ProgressManager;
...
public class BreakProgress extends Module {
    ...
    public void onRenderWorld(RenderWorldLastEvent e) {
        if (this.progress == 0.0f || this.block == null || !Utils.nullCheckPasses()) {
            return;
        }
