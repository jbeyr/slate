...
public final class DynamicManager extends Module {
    ...
    public DynamicManager() {
        ...
        directory = new File(Main.mc.mcDataDir + File.separator + Main.MODID, "dynamics");
        if (!directory.exists()) {
    ...
    private static @NotNull Set<File> getClassPath() {
        ...
        classPath.add(new File(Main.class.getProtectionDomain().getCodeSource().getLocation().getFile()));
    ...
    public void loadDynamics() {
        ...
        try (URLClassLoader classLoader = new URLClassLoader(urls, getClass().getClassLoader())) {
            Class<?> dynamicInterface = classLoader.loadClass("slate.dynamic.Dynamic");
